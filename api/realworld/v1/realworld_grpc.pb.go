...
type RealWorldClient interface {
	...
	RegisterRequest(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*UserReply, error)
...
func (c *realWorldClient) RegisterRequest(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/RegisterRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealWorldServer interface {
	...
	RegisterRequest(context.Context, *LoginRequest) (*UserReply, error)
...
func (UnimplementedRealWorldServer) RegisterRequest(context.Context, *LoginRequest) (*UserReply, error) {
...
func _RealWorld_RegisterRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).RegisterRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/RegisterRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).RegisterRequest(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RealWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RealWorld_RegisterRequest_Handler,
		},
		{
